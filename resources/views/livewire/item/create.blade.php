    ...
    <div class="max-w-md w-full mx-4 bg-white p-8 rounded shadow-lg mt-20">
        ...
        <form>
            <div class="mb-4">
                ...
                <button wire:click.prevent="createItem()" class="bg-white hover:bg-gray-100 text-black font-bold py-2 px-4 border border-gray-300 rounded focus:outline-none">
                    Save
                </button>
            </div>
        </form>
